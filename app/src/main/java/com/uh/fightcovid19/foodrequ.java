...
public class foodrequ extends AppCompatActivity {
    Button back;
    ImageView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.foodrequ);



        img = findViewById(R.id.imageView);
        Picasso.get().load(R.drawable.xyz).fit().into(img);
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(subject)) {
                    your_subject.setError("Enter Your addresss");
                    your_subject.requestFocus();
                    return;
                }

                if (TextUtils.isEmpty(message)) {
                    your_message.setError("Enter item needed");
